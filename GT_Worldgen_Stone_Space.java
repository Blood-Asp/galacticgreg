...
public class GT_Worldgen_Stone_Space
  extends GT_Worldgen_Ore
{
  public GT_Worldgen_Stone_Space(String aName, boolean aDefault, Block aBlock, int aBlockMeta, int aDimensionType, int aAmount, int aSize, int aProbability, int aMinY, int aMaxY, Collection<String> aBiomeList, boolean aAllowToGenerateinVoid)
  {
  ...
  {
    if (((this.mBiomeList.isEmpty()) || (this.mBiomeList.contains(aBiome))) && ((this.mProbability <= 1) || (aRandom.nextInt(this.mProbability) == 0)))
    {
                      ...
                      if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D)
                      {
                        ...
                        if (tTargetedBlock == GregTech_API.sBlockOres1)
                        {
                          ...
                          if ((tTileEntity instanceof PrefixBlockTileEntity)) {
                              ((PrefixBlockTileEntity)tTileEntity).mMetaData = (byte)this.mBlockMeta;
                          }
                        }
